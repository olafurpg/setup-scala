...
function installSbt() {
    ...
    shell.mkdir(bin);
    core.addPath(bin);
    curl("https://raw.githubusercontent.com/sbt/sbt-launcher-package/master/src/universal/bin/sbt", path.join(bin, "sbt"));
    curl("curl -sl curl -sL https://raw.githubusercontent.com/coursier/sbt-extras/master/sbt", path.join(bin, "csbt"));
}
