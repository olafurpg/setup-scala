...
function installSbt() {
    ...
    core.addPath(bin);
    curl("https://raw.githubusercontent.com/sbt/sbt/develop/sbt", path.join(bin, "sbt"));
    curl("https://raw.githubusercontent.com/dwijnand/sbt-extras/master/sbt", path.join(bin, "sbtx"));
